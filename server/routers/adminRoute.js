...
const { postAdminAddStudent, postAdminAddFaculty, postAdminAddSubject, 
    postAdminAddClass, postAdminAddNotice, getAdminStudents,
     getAdminFaculties, getAdminSubjects, getAdminClasses, postAdminAddClub,
      getAdminNotices, getAdminClubs, editAdminStudent, deleteFaculty, deleteStudent, deleteSubject, getFacByid, postEditAdminFaculty, getClubFaculties, deleteClub, deleteClubs, dashBoard} = require("../controllers/adminController");
