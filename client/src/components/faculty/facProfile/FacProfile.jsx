              ...
              <MDBCard className="mb-3" style={{ borderRadius: '.5rem', color: "black" }}>
                <MDBRow className="g-0">
                  <MDBCol md="4" className="gradient-custom text-center text-black"
                    ...
                    <MDBTypography tag="h5">fdf</MDBTypography>
                    <MDBCardText>riririr</MDBCardText>
                    ...
                    <MDBCardBody className="p-4">
                      ...
                      <MDBRow className="pt-1">
                        <MDBCol size="6" className="mb-3">
                          ...
                          <MDBCardText className="text-muted">dfdf</MDBCardText>
                        </MDBCol>
                        <MDBCol size="6" className="mb-3">
                          <MDBTypography tag="h6">Phone</MDBTypography>
                          <MDBCardText className="text-muted">sdfasdf</MDBCardText>
                        </MDBCol>
                      </MDBRow>
